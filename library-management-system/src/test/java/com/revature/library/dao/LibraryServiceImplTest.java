...
public class LibraryServiceImplTest {
	...
	public void testAddUser() {
		...
		libraryService.addUser(new User(userIdToTest,"demoName","student","demoName@com","1111111111","123","2020-02-20"));
	...
	public void testGetUserById() {
		int UserIdToTest = -999;
		User addedUser = new User(UserIdToTest,"demoName","student","demoName@com","1111111111","123","2020-02-20");
	...
	public void testGetUserByName() {
		...
		User addedUser = new User(UserIdToTest, userNametoTest,"student","demoName@com","1111111111","123","2020-02-20");
		libraryService.addUser(addedUser);
